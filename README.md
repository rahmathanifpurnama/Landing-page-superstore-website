...
**Giant Superstore** is a nationwide US retail enterprise specializing in three core product categories: _Furniture_, _Office Supplies_, and _Technology Products_. Operating across Central, East, South, and West regions, the company faced cut-throat market competition and needed deep data-driven visibility into:
...
2. **Customer Segmentation & Loyalty**: Classifying customers into behavioral tiers (_Buyer_, _Discount Hunter_, _Royal Buyer_) to tailor retention campaigns.
...
1. **The Discount Trap**:
   ...
   - Customers classified as _Discount Hunters_ generate significant order frequency in high discount brackets (0.4–0.8), but contribute negative net margins in sub-categories such as _Tables_ and _Bookcases_.
...
2. **Technology is the Growth Engine**:
   ...
   - Technology products (_Phones_, _Copiers_, _Accessories_) yield the highest profit-to-sales conversion ratio compared to Furniture.
   - **Recommendation**: Bundle office furniture with tech peripherals to lift overall cart profitability.

3. **Geographic Focus**:
   - _New York City_, _Los Angeles_, and _Seattle_ account for over 60% of positive profit flow, whereas cities like _Houston_ and _Philadelphia_ suffer high sales with compressed margins due to heavy local promotions.
...
- 👨‍🏫 **Dally Kharisma Muhammad** — _Data Analyst Mentor_
- 👨‍🏫 **Andra Adhiatma Nugraha** — _Software Engineering Mentor_
